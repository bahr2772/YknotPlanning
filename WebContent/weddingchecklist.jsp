			...
			<c:if test="${update == 'yes' }">
				<div class="alert alert-success" role="alert">
					<span class="glyphicon  glyphicon-ok" aria-hidden="true"></span> <span
						class="sr-only">Update Successful</span> Update Successful!
		...
		<div class="col-lg-12 ">
			<form action="CheckListServlet" method="POST">
				...
				<div class="col-md-3 col-sm-5 col-xs-12 checklist">
					...
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c0"
							<c:if test="${c0 == '1' }" >checked</c:if>>Settle on a
							Budget...</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c1"
							<c:if test="${c1 == '1' }" >checked</c:if>>Gather Guest
							Names & Addresses</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c2"
							<c:if test="${c2 == '1' }" >checked</c:if>>Narrow Down
							Wedding Date, We suggest to pick 2 or 3</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c3"
							<c:if test="${c3 == '1' }" >checked</c:if>>Search for
							Wedding Venue</label>
					</div>
					<hr>
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c5"
							<c:if test="${c5 == '1' }" >checked</c:if>>Book Venue</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c6"
							<c:if test="${c6 == '1' }" >checked</c:if>>Begin
							Shopping for the Dress</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c7"
							<c:if test="${c7 == '1' }" >checked</c:if>>Choose Bridal
							Party</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c8"
							<c:if test="${c8 == '1' }" >checked</c:if>>Hire
							Photographer</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c9"
							<c:if test="${c9 == '1' }" >checked</c:if>>Hire DJ/Band</label>
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="1" name="c10"
							<c:if test="${c10 == '1' }" >checked</c:if>>Hire
							Videoagrapher</label>
					</div>
					<hr>
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c12"
							<c:if test="${c12 == '1' }" >checked</c:if>>Set
							Appointment with Florist</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c13"
							<c:if test="${c13 == '1' }">checked</c:if>>Book Caterer</label>
					</div>
					<hr>
				</div>
				...
				<div class="col-md-3 col-sm-5 col-xs-12 checklist">
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c15"
							<c:if test="${c15 == '1' }" >checked</c:if>>Send off
							Gift Registries</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c16"
							<c:if test="${c16 == '1' }" >checked</c:if>>Search for
							Officiant</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c17"
							<c:if test="${c17 == '1' }" >checked</c:if>>Choose
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c20"
							<c:if test="${c20 == '1' }" >checked</c:if>>Plan and
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c21"
							...
							and Print Wedding Invitations</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c22"
							<c:if test="${c22 == '1' }" >checked</c:if>>Test Hair
				...
				<div class="col-md-3 col-sm-5 col-xs-12 checklist">
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c24"
							<c:if test="${c24 == '1' }" >checked</c:if>>Arrange for
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c26"
							<c:if test="${c26 == '1' }" >checked</c:if>>Purchase
							Other Bridal Items i.e shoes, garter, lingerie</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c27"
							<c:if test="${c27 == '1' }" >checked</c:if>>Plan and
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c30"
							<c:if test="${c30 == '1' }" >checked</c:if>>Finalize
				...
				<div class="col-md-3 col-sm-5 col-xs-12 checklist">
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c32"
							<c:if test="${c32 == '1' }" >checked</c:if>>Confirm
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c35"
							<c:if test="${c35 == '1' }" >checked</c:if>>Create
							Wedding Date Schedule to Hand-out</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c36"
							<c:if test="${c36 == '1' }" >checked</c:if>>Give Final
							Head Count to Caterer</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c37"
							<c:if test="${c37 == '1' }" >checked</c:if>>Finalize
							Seat Chart</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c38"
							<c:if test="${c38 == '1' }" >checked</c:if>>Confirm ALL
							Vendors' Arrival or Delivery Times</label>
					</div>
					<hr>
					...
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c39"
							...
							or Family Member be in charge of Vendors</label>
					</div>
					<div class="checkbox ">
						<label><input type="checkbox" value="1" name="c40"
							<c:if test="${c40 == '1' }" >checked</c:if>>GET MARRIED
							AND HAVE FUN!</label>
					</div>
					<hr>
				...
				<div class="row">
					<button type="submit" value="submit"
						class="btn btn-primary checklistBtn btn-block">Save
						Checklist</button>
				</div>
