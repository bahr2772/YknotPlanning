...
<%-- <c:if test="${not empty client}"> <jsp:useBean id="client" class="model.User" scope="session" /></c:if> --%>
<html lang="en">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="" id="join">Join Us</h1>
		<div class="col-lg-12 ">
			<div class="row">

				<c:if test="${sessionScope.login == 'error' }">
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> <span class="sr-only">Error:</span>
						Sorry, our bad something went wrong. If continues contact us.
					</div>
				</c:if>
				<c:if test="${sessionScope.login == 'userInDb' }">
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> <span class="sr-only">Error:</span>
				...
				<c:if test="${sessionScope.login == 'passTooSmall' }">
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> <span class="sr-only">Error:</span>
				...
				<c:if
					test="${sessionScope.login == 'emailFail' || sessionScope.login == 'userTooSmall' }">
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> <span class="sr-only">Error:</span>
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Email*</label> <input type="email"
									...
									name="email"
									value='<c:if test="${client.getEmail() != null}"><c:out value="${client.getEmail()}"></c:out></c:if>'>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Password*</label> <input type="password"
									...
									name="password"
									value='<c:if test="${client.getPassword() != null}"><c:out value="${client.getPassword() }"/></c:if>'>
							</div>
							<div class="col-sm-6 form-group">
